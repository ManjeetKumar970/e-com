...
@endif
    ...
    <script>
        ...
        const totalslidehomesEl = document.getElementById('total-slidehomes');
        const autoPlayInterval = 5000;
        let autoPlayTimer;

        // Set total slidehomes count
        totalslidehomesEl.textContent = slidehomes.length;
