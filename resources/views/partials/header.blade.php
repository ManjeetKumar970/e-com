            ...
            <div class="col-8 col-lg-3 order-lg-3 ms-lg-auto">
                <div class="d-flex justify-content-end align-items-center gap-2 gap-lg-3">
                        ...
                        @if (Auth::check())
                            ...
                            <ul class="dropdown-menu dropdown-menu-end p-2" aria-labelledby="accountDropdown">
                                <li><a class="dropdown-item d-flex align-items-center" href="#"><i
                                            class="fas fa-user me-2 text-primary"></i> My Profile</a></li>
                                <li><a class="dropdown-item d-flex align-items-center"
                                        href="{{ route('wishlist.index') }}"><i
                                            class="fas fa-heart me-2 text-danger"></i> Wishlist <span
                                            class="badge bg-secondary ms-auto">{{ $wishlistCount }}</span></a></li>
                                <li><a class="dropdown-item d-flex align-items-center" href="#"><i
                                            class="fas fa-tag me-2 text-success"></i> Coupons</a></li>
                                ...
                                <li><a class="dropdown-item d-flex align-items-center"
                                        href="{{ route('userLogout') }}"><i
                                            class="fas fa-sign-out-alt me-2 text-secondary"></i> Logout</a></li>
                            </ul>
                        @else
                    ...
                    <div class="dropdown d-lg-none">
                        <a href="#" class="text-dark" id="accountDropdownMobile" data-bs-toggle="dropdown"
                            aria-expanded="false">
                        ...
                        <div class="dropdown-menu dropdown-menu-end shadow border-0 rounded-4 p-0"
                            ...
                            @if ($cartCollection->isEmpty())
                                ...
                                <div class="text-center py-5 px-3">
                                    <i class="fas fa-shopping-cart text-muted mb-3"
                                ...
                                <div class="overflow-auto" style="max-height: 350px;">
                                    @foreach ($cartItems as $item)
                                        <div class="d-flex align-items-center p-3 border-bottom position-relative">
                                            <!-- Product Image -->
                                            <a
                                                href="{{ url('productreview/' . $item->product->slug . '/' . $item->product->id) }}">
                                            ...
                                            <div class="d-flex flex-column align-items-end gap-2">
                                                ...
                                                <div class="d-flex align-items-center border rounded"
                                                    ...
                                                    <span class="px-3 py-1 fw-semibold "
                                                        style="font-size: 0.9rem; min-width: 30px; text-align: center;">
                                                        {{ $item->quantity }}
                                                    </span>
                                                    <button class="btn btn-sm border-0 px-2 py-1"
                                                        style="font-size: 0.75rem; color: #9ca3af;">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="fw-semibold"
                                            style="color: #60a5fa; font-size: 1.1rem;">Subtotal:</span>
            ...
            <div class="col-12 col-lg-7 order-lg-2 mt-2 mt-lg-0 search-bar-wrapper">
                <div class="input-group">
                    <input type="text" class="form-control"
                        placeholder="Search for thermal printers, barcode labels..."
...
<script>
    ...
    function addToCart(element) {
        ...
        const card = element.closest(
            '.product-card-hot-deel, .product-card-hot, .product-card-pd, .productview, .card-actions-ws');
        if (!card) {
    ...
    window.addEventListener('load', () => {
        const cards = document.querySelectorAll(
            '.product-card-hot-deel,product-card-hot ,.product-card-pd ,.productview');
