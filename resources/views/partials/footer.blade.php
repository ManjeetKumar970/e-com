            ...
            <div class="container">
                ...
                <div class="row justify-content-center fs-15 lh-28 pb-50px xs-pb-35px">
                    ...
                    <div class="col-6 col-lg-3 col-md-4 col-sm-5 md-mb-50px xs-mb-30px order-sm-2 order-lg-2 offset-md-2 offset-lg-0">
                        ...
                        <div class="mb-15px"><i class="feather icon-feather-mail fs-16 text-white me-10px xs-me-5px"></i><a href="/cdn-cgi/l/email-protection#97fef9f1f8d7f3f8faf6fef9b9f4f8fa" class="text-decoration-line-bottom"><span class="__cf_email__" data-cfemail="f1989f979eb1959e9c90989fdf929e9c">[email&#160;protected]</span></a></div>
