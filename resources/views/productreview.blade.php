                ...
                <div class="col-lg-6 mb-4">
                    <div class="product-image-container" id="main-product-image">
                        <img src="{{ asset('storage/' . ($product->primaryImage->image_url ?? 'images/no-image.png')) }}"
                            alt="{{ $product->name }}" class="product-image-pv" id="mainProductImage">
                    </div>
                    ...
                    <div class="video-container position-relative"
                        ...
                        @if (!empty($product->product_video_url))
                            ...
                            @if ($videoId)
                                <div id="video-placeholder-{{ $videoId }}"
                                    class="video-placeholder position-absolute top-0 start-0 w-100 h-100"
                                    style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); cursor: pointer;"
                                    onclick="playVideo('{{ $videoId }}')">
                                    <div
                                        class="video-overlay d-flex flex-column justify-content-center align-items-center h-100">
                                ...
                                <div id="video-iframe-{{ $videoId }}"
                                    class="position-absolute top-0 start-0 w-100 h-100" style="display: none;">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="mb-4">
                        ...
                        <div>
                            ...
                            <span
                                class="discount-badge">{{ round(100 - ($product->sale_price / $product->regular_price) * 100) }}%
                                off</span>
                        </div>
                    </div>
        ...
        <div class="row g-4">
            @foreach ($relatedProducts as $relatedProduct)
                <div class="col-md-6 col-lg-3">
                    <a href="{{ route('product.show', ['slug' => $relatedProduct->slug, 'id' => $relatedProduct->id]) }}"
                        style="text-decoration: none; color: inherit;">
                        <div class="product-card">

                            <div class="product-image">
                                <img src="{{ asset('storage/' . ($relatedProduct->primaryImage->image_url ?? 'images/no-image.png')) }}"
                                    alt="" class="img-fluid">
                            </div>
            ...
            <div class="col-12">
                ...
                <div id="reviewsList">
                    ...
                    <div class="review-card">
                        ...
                        <p class="review-text">I purchased this for my restaurant and it's been working flawlessly for
                            6 months now. Print quality is crisp, speed is impressive, and the setup was very easy.
                            Handles high volume printing during rush hours without any issues. Highly recommended for
                            commercial use.</p>
                    ...
                    <div class="review-card hidden" data-hidden-review>
                        ...
                        <p class="review-text">Perfect for our retail store. The ethernet connectivity makes it easy to
                            connect to our POS system. Print speed is fantastic and paper loading is very convenient.
                            FormationTech's customer service was also very helpful during setup.</p>
                        <div class="review-actions">
                    ...
                    <div class="review-card hidden" data-hidden-review>
                        ...
                        <p class="review-text">Overall satisfied with the printer performance. Print quality and speed
                            are good. Had some initial setup issues with drivers on Windows 11, but FormationTech
                            support helped resolve it quickly. Would recommend having technical support readily
                            available during installation.</p>
                        <div class="review-actions">
                ...
                <div class="action-buttons">
                    <button class="btn btn-primary" id="showMoreBtn" onclick="showMoreReviews()">Show More
                        Reviews</button>
        ...
        <div class="modal-content">
            ...
            <form onsubmit="submitReview(event)">
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" id="reviewerName" placeholder="Enter your name"
                        required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" id="reviewTitle" placeholder="Sum up your experience"
                        required>
                </div>
                ...
                <div class="accordion" id="faqAccordion">
                    <div class="accordion-item">
                        ...
                        <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                This printer supports various paper sizes including 80mm thermal paper rolls, which are
                                standard for receipt printing.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Yes, we provide comprehensive installation support including driver setup and
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="faq3" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                With proper maintenance, this printer is designed to last 5-7 years in commercial
                                environments with moderate to heavy usage.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="faq4" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                Yes, this printer supports mobile connectivity and is compatible with various mobile POS
                                applications.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="faq5" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                            <div class="accordion-body">
                                This printer comes with a 2-year manufacturer warranty covering parts and labor for any
            ...
            <div class="policy-grid">
                <div class="policy-card">
                    ...
                    <p class="policy-description">
                        Easy returns within 7 days of delivery. No questions asked for unused items in original
                        packaging.
                    </p>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const elements = document.querySelectorAll(
                '.product-image-container, .thumbnail-container, .video-placeholder, h1, .rating-stars, .current-price, .product-specs-table'
                );
