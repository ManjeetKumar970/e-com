                ...
                <div>
                    ...
                    <div class="form-card">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="shortDescription" name="short_description" 
                                      rows="2" placeholder="Brief product description (max 500 characters)" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="fullDescription" name="description" 
                                      rows="6" placeholder="Detailed product description, features, and benefits..."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-card">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <div class="price-input-group">
                                    ...
                                    <input type="number" class="form-control" id="regularPrice" name="regular_price" 
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="isTaxable" name="is_taxable" checked>
                    ...
                    <div class="form-card">
                        ...
                        <div class="mb-3">
                            <label for="packageContents" class="form-label">Package Contents (What's in the box)</label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="usage_instructions" rows="3" 
                    ...
                    {{-- <div class="form-card">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="meta_description" 
                                      rows="3" placeholder="SEO description" maxlength="160"></textarea>
                            <small class="text-muted">
                ...
                <div>
                    ...
                    <div class="form-card sidebar-card">
                        ...
                        <div id="bulkPricingSection" style="display: none;">
                            ...
                            <button type="button" class="btn btn-sm btn-outline-primary w-100" onclick="addBulkPricing()">
    ...
    <script>
        ...
        document.getElementById('productName').addEventListener('input', function(e) {
            const slug = e.target.value
                ...
                .replace(/[^a-z0-9]+/g, '-')
                .replace(/^-+|-+$/g, '');
            // Slug field can be added if needed
        });
        ...
        // Calculate profit margin and price with GST
        ...
        document.getElementById('productForm').addEventListener('submit', function(e) {
            ...
            if (!document.getElementById('productType').value) {
                ...
                document.querySelector('.product-type-selector').scrollIntoView({ behavior: 'smooth' });
                return;
            }
            ...
            setTimeout(() => {
                ...
                // In real implementation, redirect to product list
