...
<body>
    ...
    <div class="main-container ">
        ...
        <div class="container card card-box mt-3 pd-20 mb-20">
            <form id="product-form" method="POST" action="{{ route('dashboard.storeProduct') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 md-2">
                        <div class="form-floating">
                            <input name="numberoflabel" class="form-control" type="number"
                                placeholder="Number Of Labels" required />
