...
<body>
    ...
    <div class="main-container">
        <div class="container">
            ...
            <div class="card card-box mb-4">
                <div class="card-body">
                    <form action="{{ route('slider.upload') }}" method="POST" enctype="multipart/form-data" id="sliderForm">
                        @csrf
                        ...
                        @endif
                         <div class="row">
                            ...
                            <div class="form-floating form-group">
                                <input name="title" class="form-control" type="text" placeholder="Img Title" required />
                                <label>Title *</label>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 md-2">
                            <div class="form-floating">
                                <input name="dscription" class="form-control" type="text" placeholder="dscription" required />
                        ...
                        <div class="mb-4">
                            ...
                            <small class="text-muted">Accepted formats: JPG, JPEG, PNG, WEBP. Maximum size: 2MB per image</small>
                        </div>
    ...
    if (files.length > 0) {
        ...
        document.getElementById('sliderForm').addEventListener('submit', function(e) {
            ...
            if (totalCount > 4) {
                e.preventDefault();
                alert(`You can only have 4 slider images total. You currently have ${currentCount} images and trying to add ${files.length} more.`);
                return false;
            }
        });
    </script>
