                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <div class="notification-list mx-h-350 customscroll">
                        <ul>
                            <li>
                                <a href="#">
                                    <img src="{{ asset('vendors/images/img.jpg') }}" alt="A professional headshot of a smiling individual in formal attire, set against a neutral background, conveying a friendly and approachable demeanor" />
                                    <h3>John Doe</h3>
                                    <p>
